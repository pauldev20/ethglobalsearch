        ...
        <nav className={`py-2 ${mobileMenuOpen ? "bg-background" : ""}`}>
            <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full relative flex h-16 flex-row items-center justify-between">
                ...
                <div className="absolute right-8 flex items-center">
                    ...
                    >
                        <svg width="32" height="25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path stroke="currentColor" d="M0 .5h32M0 12.5h32M0 24.5h32" />
                        </svg>
                    </button>
                </div>
                ...
                <ul
                    ...
                    style={{
                        boxShadow: "rgba(50, 50, 93, 0.2) 0px 10px 12px -2px, rgba(0, 0, 0, 0.2) 0px 10px 4px -2px",
                    }}
                >
                    <div className="py-2">
                        ...
                        <li className="group relative text-left">
                            ...
                            >
                                <span>
                                    Ask Talwar
                                    <span className="inline-flex items-center rounded-full bg-green-100 px-1.5 py-0.5 text-xs -translate-y-2 font-semibold text-green-800 ml-1">
                                        New
                                    </span>
                                </span>
                            </a>
